...
public class Map implements Serializable {
	...
	/**
	 * tworzy wirtualna tablice jako mape
	 */
	public Map() {
		map = new int[10][10];
		// int i,j;
	...
	/**
	 * ustawia na wirtualnej mapie wszystkie przyciski wokol jako zablokowane (nie mozna juz ukladac tam statku, nie mozna juz tam klikac gdy statek jest juz zatopiony)
	 * @param x wsp x
	 * @param y wsp y
	 */
