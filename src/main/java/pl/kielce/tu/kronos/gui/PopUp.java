...
/**
 * klasa tworzaca wyskkuajce okienko z informacje o tym, czy sie wygralo, przegralo, badz z odpowiednimi komunikatami dotyczacymi logowania/rejestracji
...
public class PopUp extends MainWindow {
	...
	public static void display(String data) throws IOException {
		...
		scene.getStylesheets().add(PopUp.class.getResource("/stylesheet/Stylesheet.css").toString());
