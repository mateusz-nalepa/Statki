...
/**
 * klasa odpowiada za uklad przyciskow oraz uzskuje referencje do nich, dzieki czemu mozna na nich operowac
...
public class ControllerShipsLocation  extends MainWindow implements Initializable {
	...
	/**
	 * ustawia odpowiednie pola i referencji w klasie shipslogic, ktora jest jako singleton
	 * @throws IOException
	 */
	...
	/**
	 * zmienia dlugosc statku w comboboxie pokliknieciu
	 * @param typeOfShipList - dlugosc statku
	 * @param nickAndNumberOfFlagstaff - nazwa gracza i rodzaj statku
	 */
	...
	/**
	 * ustawia odpowiednio orientajce od danego pola gdy kliknie sie w odpowiednio pozycje na comboboxie
	 * @param orientationList - lista ktora jest ladowana do comboboxa w ktorej jest info o orientacji statku
	 */
	...
	/**
	 * ustawia odpowiednim przyciskom jakie akcje maja byc wykonywane po kliknieciu na nie, zjechanie, najechanie, scrollowanie i klikanie prawym przcyskiem myszy
	 */
	public void setXY() {
