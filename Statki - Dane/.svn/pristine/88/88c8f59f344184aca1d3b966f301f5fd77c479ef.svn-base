...
public class ControllerDuel extends MainWindow implements Initializable {
	...
	/**
	 * ustawia co ma sie stac, gdy sie najedzie na przycisk
	 * @param x - wsp x 
	 * @param y - wsp y
	 */
	...
	/**
	 * ustawia co ma sie stac, gdy sie kliknie na przycisk
	 * @param x - wsp x 
	 * @param y - wsp y
	 */
	...
	/**
	 * ustawia co ma sie stac, gdy sie zjedzie z przycisku
	 * @param x - wsp x 
	 * @param y - wsp y
	 */
	...
	/**
	 * ustawia odpowiednim przyciskom jakie akcje maja byc wykonywane po najechaniu na buttona, zjechaniu z niego i kliknieciu
	 */
	...
	/**
	 * ustawia jaka akcje maja byc wykonywane podczas przewijana scrollpane
	 */
