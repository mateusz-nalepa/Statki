 ...
 * Klasa zawiera logike odpowiedzialna za logowanie oraz rejestracje a takze dane ktore sa potrzebne do wyswietlania wyskakujacych okienek w ktorych sa informacje na temat ewentualnego bledu
 *
 */
public class Model {
	...
	/**
	 * 
	 * @return instancja klasa jako Singleton
	 */
	...
	/**
	 * 
	 * @param fxml - nazwa pliki fxml ktory chcemy wczytac
	 */
